...
const isReporting = process.argv.includes('--report')
	...
	rules: [
		...
		},
		{
			...
			use: [
				...
				// css-loader的sourceMap属性为false时可能导致有的字体加载失败
				// 因此, dev模式下sourceMap为true, 预发和生产环境去除sourceMap属性
				{
					loader: 'css-loader',
...
const plugins = [
	...
	new BundleAnalyzerPlugin({analyzerMode: !isReporting ? 'disabled' : 'server'}),
